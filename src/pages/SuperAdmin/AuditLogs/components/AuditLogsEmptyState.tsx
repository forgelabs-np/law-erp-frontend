...
export const AuditLogsEmptyState = ({ hasFilters, onResetFilters }: AuditLogsEmptyStateProps) => {
  return (
    <Stack align="center" justify="center" py={12} gap={4}>
      ...
      <Text textStyle="paragraph_regular" color="gray.500" textAlign="center" maxW="400px">
        {hasFilters
